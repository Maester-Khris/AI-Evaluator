...
export const ChatMessage = ({
	...
	return (
		<div
			className={`w-full border-b border-white/[0.03] py-10 transition-colors ${
				isAssistant ? "bg-blue-500/[0.01]" : "bg-transparent"
			}`}
		>
			<div
			...
			>
				...
				<div className="flex flex-col items-center gap-3">
					<div
						className={`flex-shrink-0 w-9 h-9 rounded-lg flex items-center justify-center border shadow-xl ${
							isAssistant
				...
				>
					...
					<div
						className={`prose prose-invert prose-sm max-w-none text-slate-300 selection:bg-blue-500/30 ${!isAssistant ? "text-right" : ""}`}
					>
