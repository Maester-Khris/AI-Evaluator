...
const initialConversations = [
  { id: '1', title: 'Project feedback', last: 'Looks good — just tweak the copy.' },
  { id: '2', title: 'Interview prep', last: 'Focus on system design questions.' },
  { id: '3', title: 'Bug triage', last: 'Repro steps added in latest comment.' },
  // ...existing data...
]
